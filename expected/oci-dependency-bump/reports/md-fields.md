...
- metadata.labels.helm.sh/chart: ocidep-6.7.0
+ metadata.labels.helm.sh/chart: ocidep-6.7.1
```
...
- metadata.labels.helm.sh/chart: ocidep-6.7.0
+ metadata.labels.helm.sh/chart: ocidep-6.7.1
- spec.template.spec.containers[name=ocidep].image: ghcr.io/stefanprodan/podinfo:6.7.0
+ spec.template.spec.containers[name=ocidep].image: ghcr.io/stefanprodan/podinfo:6.7.1
```
